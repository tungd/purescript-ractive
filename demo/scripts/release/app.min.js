...
/***/ function(module, exports, __webpack_require__) {
	...
	var main = function __do() {
	    ...
	    Control_Monad_Eff_Ractive.on("logo-clicked")(function (r) {
	        return function (e) {
	            return function __do() {
	                var v1 = Control_Monad_Eff_Ractive.get("canRandomize")(r)();
	                return (function () {
	                    if (v1) {
	                        return setRandom(r);
	                    };
	                    ...
	                    throw new Error("Failed pattern match at DemoApp.WithRactive line 28, column 1 - line 29, column 1: " + [ v1.constructor.name ]);
	                })()();
	            };
	        };
	    })(v)();
	    Control_Monad_Eff_Ractive.on("control-button-clicked")(function (r) {
	        return function (e) {
	            return function __do() {
	                var v1 = Control_Monad_Eff_Ractive.get("canRandomize")(r)();
	                return change("canRandomize")(inverse(v1))(r)();
	            };
	        };
	    })(v)();
