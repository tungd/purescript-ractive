var DemoApp = DemoApp || {}; DemoApp["ractive"] =
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Data_Maybe = __webpack_require__(3);
	var Control_Monad_Eff = __webpack_require__(11);
	var Control_Monad_Eff_Console = __webpack_require__(13);
	var Control_Monad_Eff_Ractive = __webpack_require__(15);
	var Control_Monad_Eff_Random = __webpack_require__(20);
	var ContT = function (x) {
	    return x;
	};
	var inverse = function (canRand) {
	    return !canRand;
	};
	var change = function (property) {
	    return function (value) {
	        return function (ractive) {
	            return Control_Monad_Eff_Ractive.set(property)(value)(ractive);
	        };
	    };
	};
	var onControlButtonClicked = function (r) {
	    return function (e) {
	        return function __do() {
	            var v = Control_Monad_Eff_Ractive.get("canRandomize")(r)();
	            return change("canRandomize")(inverse(v))(r)();
	        };
	    };
	};
	var setRandom = function (ractive) {
	    return function __do() {
	        var v = Control_Monad_Eff_Random.random();
	        return change("message")(v)(ractive)();
	    };
	};
	var onLogoClicked = function (r) {
	    return function (e) {
	        return function __do() {
	            var v = Control_Monad_Eff_Ractive.get("canRandomize")(r)();
	            return (function () {
	                ...
	                if (!v) {
	                    return change("message")("Randomization disabled!")(r);
	                };
	                throw new Error("Failed pattern match at DemoApp.WithRactive line 34, column 1 - line 35, column 1: " + [ v.constructor.name ]);
	            })()();
	        };
	    };
	};
	var writeLog = function (ractive) {
	    return function (logName) {
	        return function (message) {
	            return function __do() {
	                var v = Control_Monad_Eff_Ractive.get(logName)(ractive)();
	                return (function () {
	                    var newLog = v + message;
	                    return change(logName)(newLog)(ractive);
	                })()();
	            };
	        };
	    };
	...
	var main = (function () {
	    var componentSettings = new Control_Monad_Eff_Ractive.Data({
	    ...
	    var component = Control_Monad_Eff_Ractive.extend(componentSettings);
	    var appSettings = new Control_Monad_Eff_Ractive.Data({
	        template: "#template", 
	        el: "#app", 
	        data: {
	            uiLibrary: "RactiveJS", 
	    ...
	    return function __do() {
	        var v = Control_Monad_Eff_Ractive.ractive(appSettings)();
	        Control_Monad_Eff_Ractive.on("logo-clicked")(onLogoClicked(v))(v)();
	        Control_Monad_Eff_Ractive.on("control-button-clicked")(onControlButtonClicked(v))(v)();
	        Control_Monad_Eff_Ractive.push("numbers")(12345)(new Data_Maybe.Just(function (p) {
	            return writeLog(v)("consoleMessages")("\r\n\r\npush completed");
	        }))(v)();
	        Control_Monad_Eff_Ractive.pop("numbers")(new Data_Maybe.Just(function (result) {
	            return writeLog(v)("consoleMessages")("\r\n\r\ngot value: " + result);
	        }))(v)();
	        Control_Monad_Eff_Ractive.observe("message")(function (n) {
	            return function (o) {
	                return function (kp) {
	                    return writeLog(v)("consoleMessages")("\r\n\r\nrandom: " + n);
	                };
	        ...
	        Control_Monad_Eff_Ractive.observe("counter")(function (n) {
	            return function (o) {
	                return function (kp) {
	                    return writeLog(v)("consoleMessages")("\r\n\r\ncounter: " + n);
	                };
	        ...
	        var v1 = Control_Monad_Eff_Ractive.find(".app-logo")(v)();
	        var v2 = Control_Monad_Eff_Ractive.findAll("div")(Data_Maybe.Nothing.value)(v)();
	        Control_Monad_Eff_Ractive.add("counter")(new Data_Maybe.Just(5.0))(new Data_Maybe.Just(function (r) {
	            return Control_Monad_Eff_Console.log("Counter incremented!");
	        }))(v)();
	        Control_Monad_Eff_Ractive.subtract("counter")(new Data_Maybe.Just(1.0))(new Data_Maybe.Just(function (r) {
	            return Control_Monad_Eff_Console.log("Counter decremented!");
	        }))(v)();
	        Control_Monad_Eff_Ractive.animate("message")("Click on the PureScript Logo! :)")(Data_Maybe.Nothing.value)(v)();
	        var v3 = Control_Monad_Eff_Ractive.get("message")(v)();
	        return Control_Monad_Eff_Console.log(v3)();
	    };
	})();
	module.exports = {
	    ContT: ContT, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Prelude = __webpack_require__(1);
	var Control_Alt = __webpack_require__(4);
	var Control_Alternative = __webpack_require__(5);
	var Control_Extend = __webpack_require__(7);
	var Control_MonadPlus = __webpack_require__(8);
	var Control_Plus = __webpack_require__(6);
	var Data_Functor_Invariant = __webpack_require__(9);
	var Data_Monoid = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by psc version 0.8.0.0
	"use strict";
	var $foreign = __webpack_require__(12);
	var Prelude = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Control_Monad_Eff = __webpack_require__(11);
	var Data_Maybe = __webpack_require__(3);
	var Data_Foreign_EasyFFI = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Prelude = __webpack_require__(1);
	var Control_Monad_Eff = __webpack_require__(11);
	var Data_Int = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Prelude = __webpack_require__(1);
	var Data_Int_Bits = __webpack_require__(24);
	var Data_Maybe = __webpack_require__(3);
	var Data_Maybe_Unsafe = __webpack_require__(26);
