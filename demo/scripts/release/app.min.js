...
/***/ function(module, exports, __webpack_require__) {
	...
	var main = function __do() {
	    ...
	    Control_Monad_Eff_Ractive.on("logo-clicked")(onLogoClicked)(v)();
	    Control_Monad_Eff_Ractive.on("control-button-clicked")(onControlButtonClicked)(v)();
	    Control_Monad_Eff_Ractive.push("numbers")(12345)(new Data_Maybe.Just(function (p) {
	        return Control_Monad_Eff_Console.log("push completed");
	    }))(v)();
	    Control_Monad_Eff_Ractive.pop("numbers")(new Data_Maybe.Just(function (r) {
	        return Control_Monad_Eff_Console.log("got value: " + r);
	    }))(v)();
