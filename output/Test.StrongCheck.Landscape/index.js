    ...
    return function (n) {
        return function ($20) {
            return Data_Lazy.force(Control_Monad_List_Trans.foldl(Data_Lazy.monadLazy)(function (b) {
                return function (a) {
                    return Data_Array[":"](a)(b);
                };
            })([  ])(Control_Monad_List_Trans.take(Data_Lazy.applicativeLazy)(n)(Prelude["<$>"](Control_Monad_List_Trans.functorListT(Data_Lazy.functorLazy))(Control_Comonad_Cofree.head)(Control_Comonad_Cofree.tail(unLandscape($20))))));
        };
    };
};
var sampleHere = function (dictPerturb) {
    return function (n) {
        return function ($21) {
            return Prelude["<$>"](Prelude.functorArray)(Prelude[">>>"](Prelude.semigroupoidFn)(unDriverState)(function (v) {
                return v.value;
                ...
                var moveIt = function (a1) {
                    return function ($22) {
                        return Data_Lazy.force(Control_Monad_List_Trans.head(Data_Lazy.monadLazy)(Control_Monad_List_Trans.filter(Data_Lazy.functorLazy)(function (v1) {
                            return Prelude["=="](dictEq)((unDriverState(Control_Comonad_Cofree.head(v1))).value)(a1);
                        })(Control_Comonad_Cofree.tail(unLandscape($22)))));
                    };
                };
            ...
            return function (a) {
                return function (v) {
                    var loop = function (a1) {
                        return function (s1) {
                            return function (v1) {
                                return Prelude.bind(Control_Monad_List_Trans.bindListT(Data_Lazy.monadLazy))(Test_StrongCheck_Gen.toLazyList(Test_StrongCheck_Gen.infinite(Control_Monad_Free.freeMonad)(Test_StrongCheck_Perturb.perturb(dictPerturb)(v1)(a1)))(s1))(function (v2) {
                                    var h = mkState(v2)(v1)(s1);
                                    var t = loop(v2)(Test_StrongCheck_Gen.updateSeedState(s1))(d(v1));
                                    return Prelude["return"](Control_Monad_List_Trans.applicativeListT(Data_Lazy.monadLazy))(Control_Comonad_Cofree.mkCofree(h)(t));
                                });
                            };
                        };
                    };
                    ...
                    var go = function (g1) {
                        return function (s1) {
                            return Data_Lazy.defer(function (v1) {
                                var o = Prelude["<$>"](Data_Maybe.functorMaybe)(Test_StrongCheck_Gen.unGenOut)(Control_Monad_Trampoline.runTrampoline(Test_StrongCheck_Gen.applyGen(Control_Monad_Free.freeMonad)(s1)(g1)));
                                return Data_Maybe.maybe(Control_Monad_List_Trans.nil(Data_Lazy.applicativeLazy))(function (o__ALT) {
                                    var g2 = Data_Tuple.snd(o__ALT.value);
                                    var a = Data_Tuple.fst(o__ALT.value);
                                    return Control_Monad_List_Trans["prepend'"](Data_Lazy.applicativeLazy)(nearby$prime(dictPerturb)(o__ALT.state)(d)(a)(v))(go(g2)(o__ALT.state));
                                })(o);
                            });
                        };
                    };
...
var somewhere$prime = function (dictPerturb) {
    return function (s) {
        return function (d) {
            return function (v) {
                return function ($23) {
                    return Data_Lazy.force(Control_Monad_List_Trans.head(Data_Lazy.monadLazy)(everywhere$prime(dictPerturb)(s)(d)(v)($23)));
                };
            };
        };
    };
