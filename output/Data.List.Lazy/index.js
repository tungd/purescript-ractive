...
var step = function ($218) {
    return Data_Lazy.force(runList($218));
};
var semigroupList = new Prelude.Semigroup(function (xs) {
    return function (ys) {
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 663, column 5 - line 664, column 5: " + [ v.constructor.name ]);
        };
...
var showList = function (dictShow) {
    return new Prelude.Show(function (xs) {
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 632, column 1 - line 638, column 1: " + [ v.constructor.name ]);
        };
...
var uncons = function (xs) {
    ...
    throw new Error("Failed pattern match at Data.List.Lazy line 279, column 1 - line 280, column 1: " + [ $71.constructor.name ]);
};
    ...
    return function (xs) {
        var go = function (v) {
            return function (v1) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 446, column 3 - line 447, column 3: " + [ v.constructor.name, v1.constructor.name ]);
            };
        };
        ...
        return function (xs) {
            var go = function (v) {
                return function (v1) {
                    ...
                    throw new Error("Failed pattern match at Data.List.Lazy line 342, column 3 - line 343, column 3: " + [ v.constructor.name, v1.constructor.name ]);
                };
            };
            return Prelude["<$>"](Data_Lazy.functorLazy)(go(n))(runList(xs));
        };
        ...
        return function (ys) {
            var go = function (v) {
                return function (v1) {
                    ...
                    throw new Error("Failed pattern match at Data.List.Lazy line 613, column 3 - line 614, column 3: " + [ v.constructor.name, v1.constructor.name ]);
                };
            };
...
var $$null = function ($219) {
    return Data_Maybe.isNothing(uncons($219));
};
    ...
    return function (xs) {
        var go = function (__copy_v) {
            ...
            tco: while (true) {
                ...
                if (v instanceof Cons) {
                    var $95 = f(v.value0);
                    if ($95 instanceof Data_Maybe.Nothing) {
                        var __tco_v = step(v.value1);
                        v = __tco_v;
                        continue tco;
                    };
                    if ($95 instanceof Data_Maybe.Just) {
                        return new Cons($95.value0, mapMaybe(f)(v.value1));
                    };
                    throw new Error("Failed pattern match: " + [ $95.constructor.name ]);
                };
...
var length = function (xs) {
    var go = function (v) {
        ...
        throw new Error("Failed pattern match at Data.List.Lazy line 194, column 1 - line 195, column 1: " + [ v.constructor.name ]);
    };
    return go(step(xs));
};
var lazyList = new Control_Lazy.Lazy(function (f) {
    return List(Data_Lazy.defer(function ($220) {
        return step(f($220));
    }));
});
    ...
    var go = function (__copy_v) {
        return function (__copy_v1) {
            ...
            tco: while (true) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 291, column 1 - line 292, column 1: " + [ v.constructor.name, v1.constructor.name ]);
            };
        };
    };
    return go(step(xs));
...
var functorList = new Prelude.Functor(function (f) {
    return function (xs) {
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 672, column 5 - line 673, column 5: " + [ v.constructor.name ]);
        };
        return Prelude["<$>"](Data_Lazy.functorLazy)(go)(runList(xs));
    };
});
var fromStep = function ($221) {
    return List(Prelude.pure(Data_Lazy.applicativeLazy)($221));
};
    ...
    return function (x) {
        return function (xs) {
            var go = function (v) {
                ...
                if (v instanceof Cons) {
                    var $115 = cmp(x)(v.value0);
                    if ($115 instanceof Prelude.GT) {
                        return new Cons(v.value0, insertBy(cmp)(x)(v.value1));
                    };
                    return new Cons(x, fromStep(v));
                };
                throw new Error("Failed pattern match at Data.List.Lazy line 232, column 3 - line 233, column 3: " + [ v.constructor.name ]);
            };
            return Prelude["<$>"](Data_Lazy.functorLazy)(go)(runList(xs));
        };
    };
    ...
    return function (f) {
        return function (xs) {
            var go = function (v) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 691, column 5 - line 692, column 5: " + [ v.constructor.name ]);
            };
            return go(step(xs));
        };
    };
    ...
    return function (b) {
        return function (xs) {
            var go = function (v) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 685, column 5 - line 686, column 5: " + [ v.constructor.name ]);
            };
            return go(step(xs));
        };
    };
    ...
    return function (b) {
        return function (xs) {
            var go = function (v) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 679, column 5 - line 680, column 5: " + [ v.constructor.name ]);
            };
            return go(step(xs));
        };
    };
...
var nubBy = function (eq) {
    return function (xs) {
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 540, column 3 - line 541, column 3: " + [ v.constructor.name ]);
        };
        return Prelude["<$>"](Data_Lazy.functorLazy)(go)(runList(xs));
    };
};
            ...
            var go = function (__copy_v) {
                return function (__copy_v1) {
                    ...
                    tco: while (true) {
                        ...
                        if (v instanceof Cons && v1 instanceof Cons) {
                            var $141 = Prelude.compare(dictOrd)(v.value0)(v1.value0);
                            if ($141 instanceof Prelude.EQ) {
                                var __tco_v = step(v.value1);
                                var __tco_v1 = step(v1.value1);
                                v = __tco_v;
                                v1 = __tco_v1;
                        ...
                        throw new Error("Failed pattern match at Data.List.Lazy line 646, column 1 - line 657, column 1: " + [ v.constructor.name, v1.constructor.name ]);
                    };
                };
            };
            return go(step(xs))(step(ys));
        ...
        var go = function (__copy_v) {
            return function (__copy_v1) {
                ...
                tco: while (true) {
                    ...
                    throw new Error("Failed pattern match at Data.List.Lazy line 463, column 1 - line 464, column 1: " + [ v.constructor.name, v1.constructor.name ]);
                };
            };
        };
        return Prelude["<$>"](Data_Lazy.functorLazy)(go(n))(runList(xs));
    ...
    return function (x) {
        return function (xs) {
            var go = function (v) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 569, column 3 - line 570, column 3: " + [ v.constructor.name ]);
            };
            return Prelude["<$>"](Data_Lazy.functorLazy)(go)(runList(xs));
        };
    };
    ...
    return function (xs) {
        var go = function (v) {
            return function (v1) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 328, column 3 - line 329, column 3: " + [ v.constructor.name, v1.constructor.name ]);
            };
        };
        return Prelude["<$>"](Data_Lazy.functorLazy)(go(n))(runList(xs));
    };
    ...
    return function (x) {
        return function (xs) {
            ...
            var go = function (v1) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 315, column 3 - line 316, column 3: " + [ v1.constructor.name ]);
            };
            return Prelude["<$>"](Data_Lazy.functorLazy)(go)(runList(xs));
        };
    };
    ...
    var go = function (__copy_acc) {
        return function (__copy_v) {
            ...
            tco: while (true) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 381, column 1 - line 382, column 1: " + [ acc.constructor.name, v.constructor.name ]);
            };
        };
    };
    ...
    return function (end) {
        ...
        if (Prelude.otherwise) {
            ...
            return go(end)(start)((function () {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 162, column 1 - line 163, column 1: " + [ $182.constructor.name ]);
            })())(nil);
        };
        throw new Error("Failed pattern match at Data.List.Lazy line 162, column 1 - line 163, column 1: " + [ start.constructor.name, end.constructor.name ]);
    };
};
var $dot$dot = range;
var span = function (p) {
...
var groupBy = function (eq) {
    return function (xs) {
        var go = function (v) {
            ...
            if (v instanceof Cons) {
                var $191 = span(eq(v.value0))(v.value1);
                return new Cons(cons(v.value0)($191.init), groupBy(eq)($191.rest));
            };
            throw new Error("Failed pattern match at Data.List.Lazy line 518, column 3 - line 519, column 3: " + [ v.constructor.name ]);
        };
        return Prelude["<$>"](Data_Lazy.functorLazy)(go)(runList(xs));
    };
};
    ...
    return function (f) {
        return function (xs) {
            var go = function (v) {
                ...
                throw new Error("Failed pattern match at Data.List.Lazy line 706, column 5 - line 707, column 5: " + [ v.constructor.name ]);
            };
            return go(step(xs));
        };
    };
...
var unfoldableList = new Data_Unfoldable.Unfoldable(function (f) {
    return function (b) {
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 694, column 1 - line 702, column 1: " + [ v.constructor.name ]);
        };
        return go(f(b));
    };
});
var concatMap = function (f) {
    return function (xs) {
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.Lazy line 400, column 3 - line 401, column 3: " + [ v.constructor.name ]);
        };
        return Prelude["<$>"](Data_Lazy.functorLazy)(go)(runList(xs));
    };
};
                ...
                return function (v1) {
                    ...
                    if (v === 0 && v1 instanceof Cons) {
                        ...
                        if ($212 instanceof Data_Maybe.Just) {
                            return new Cons($212.value0, v1.value1);
                        };
                        throw new Error("Failed pattern match at Data.List.Lazy line 368, column 3 - line 369, column 3: " + [ $212.constructor.name ]);
                    };
                    if (v1 instanceof Cons) {
                        return new Cons(v1.value0, alterAt(v - 1)(f)(v1.value1));
                    };
                    throw new Error("Failed pattern match at Data.List.Lazy line 368, column 3 - line 369, column 3: " + [ v.constructor.name, v1.constructor.name ]);
                };
            };
            return Prelude["<$>"](Data_Lazy.functorLazy)(go(n))(runList(xs));
        };
...
var modifyAt = function (n) {
    return function (f) {
        return alterAt(n)(function ($222) {
            return Data_Maybe.Just.create(f($222));
        });
    };
};
